...
public class IndexadorECommerce {
	...
	doc.add(new Field("id.produto", prod.getId().toString(), Store.YES, Index.ANALYZED));
	...
	doc.add(new Field("textoCompleto", textoCompleto.toString(), Store.YES, Index.ANALYZED));
